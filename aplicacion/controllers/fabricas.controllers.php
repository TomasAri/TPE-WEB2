...
class fabricasControllers{
    ...
    public function __construct() {
        ...
        $this->view = new fabricasView(); // Asegúrate de inicializar también la vista si es necesario
    }
    ...
    public function showFabricaDetails($id) {
        $fabrica = $this->models->getFabrica($id);
        if ($fabrica) {
            return $this->view->showdetailFabrica($fabrica);
        }
    }
}